        ...
        <section className="max-w-7xl mx-auto py-4">
          <article className="my-12 flex flex-wrap gap-4 justify-between mb-24">
            <section className="max-w-4xl mx-auto">
              ...
              <p className="text-white text-sm md:text-lg font-text max-w-lg mx-auto mb-2">
                En Easy Xplorer, somos una agencia de viajes innovadora dedicada
                a transformar la manera en que exploras el mundo. Nos
                especializamos en ofrecer experiencias de viaje únicas y
                personalizadas, diseñadas para superar las expectativas de
                nuestros clientes. Nuestra pasión por la aventura y el
                descubrimiento se combina con un enfoque creativo y un profundo
                conocimiento del mercado para proporcionar itinerarios
                excepcionales que reflejan la autenticidad y la emoción de cada
                destino.
              </p>
              <p className="text-white text-sm md:text-lg font-text max-w-lg mx-auto mb-2">
                Nos destacamos por nuestra capacidad para simplificar el proceso
                de viaje, haciendo que explorar nuevos horizontes sea accesible
                y emocionante. Con un equipo de expertos comprometidos y un
                servicio al cliente excepcional, estamos aquí para guiarte en
                cada paso del camino, asegurándonos de que cada viaje sea una
                aventura memorable y enriquecedora.
                <br />
                En Easy Xplorer, no solo te ayudamos a planificar tus
                vacaciones; transformamos cada viaje en una experiencia
                inolvidable, conectándote con el mundo de una manera que solo
            ...
            <div className="hero-content flex-col flex-col-reverse lg:flex-row">
              ...
              <div className="text-start md:text-end">
                ...
                <p className="py-6 max-w-lg">
                  En Easy Xplorer, nuestra misión es reinventar el arte de
                  viajar mediante la creación de experiencias personalizadas y
                  ...
                  nuestros clientes, ofreciendo asesoramiento experto,
                  itinerarios únicos y un servicio excepcional que haga de cada
                  viaje una aventura inolvidable.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="hero-content flex-col lg:flex-row">
              <div className="text-start">
                ...
                <p className="py-6 max-w-lg">
                  ...
                  auténticas y memorables, creando un mundo donde cada destino
                  sea una experiencia única y cada viaje, una historia que
                  contar. Nos comprometemos a explorar y expandir continuamente
                  nuestras ofertas, impulsando un cambio positivo en la manera
                  en que el mundo viaja y conecta.
                </p>
              </div>
              <img
          ...
          <section className="my-8">
            ...
            <p className="text-white mb-6 max-w-md md:max-w-lg mx-auto">
              Estos valores no solo ayudan a construir una buena reputación,
              sino que también contribuyen a la fidelización de clientes y al
              éxito sostenido de la agencia.
            </p>
